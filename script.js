...
const getWeatherData = async () => {
  ...
  try {
    // Create a const that stores the user input from the searchbar or defaults back to 'Srinagar' if left blank
    const city = searchInput.value || "Srinagar";

    // Create 2 promises that call the APIs and pass in the city name
    // If the user haven't typed anything, use Srinagar as default
